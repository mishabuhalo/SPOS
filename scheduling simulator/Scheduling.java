...
public class Scheduling {
  ...
  private static  int BlockTimeAverage = 40;
  private  static  int BlockTimeStandartDeviation = 10;
  private static  int ComingTime = 0;
  ...
  private static void Init(String file) {
    ...
    try {
      ...
      while ((line = in.readLine()) != null) {
        ...
        if (line.startsWith("BlockTimeAverage")) {
          StringTokenizer st = new StringTokenizer(line);
          st.nextToken();
          BlockTimeAverage = Common.s2i(st.nextToken());
        }
        if (line.startsWith("BlockTimeStandartDeviation")) {
          StringTokenizer st = new StringTokenizer(line);
          st.nextToken();
          BlockTimeStandartDeviation = Common.s2i(st.nextToken());
        }
        if (line.startsWith("process")) {
          StringTokenizer st = new StringTokenizer(line);
          st.nextToken();
          ioblocking = Common.s2i(st.nextToken());
          ComingTime = Common.s2i(st.nextToken());
          X = Common.R1();
          while (X == -1.0) {
            X = Common.R1();
          }
          ...
          X = X * BlockTimeStandartDeviation;
          BlockTime = (int) X + meanDev;

          processVector.addElement(new sProcess(cputime, ioblocking, 0, 0, 0, ComingTime, BlockTime, -1));
        }
  ...
  public static void main(String[] args) {
    ...
    if (processVector.size() < processnum) {
      ...
      while (processVector.size() < processnum) {       
        ...
        processVector.addElement(new sProcess(cputime,i*100,0,0,0,0,0,-1));
        i++;
      }
    }
